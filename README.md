...
* `name` (string) - name of a review item (e.g. "Change a light bulb")
...
* `Createreview` - should create a new review for a current user. A shape of data send by a client application to this function can be found in the `CreatereviewRequest.ts` file

It receives a new review item to be created in JSON format that looks like this:
...
It should return a new review item that looks like this:
...
* `Updatereview` - should update a review item created by a current user. A shape of data send by a client application to this function can be found in the `UpdatereviewRequest.ts` file

It receives an object that contains three fields that can be updated in a review item:
...
* `Deletereview` - should delete a review item created by a current user. Expects an id of a review item to remove.
...
To store review items, you might want to use a DynamoDB table with local secondary index(es). A create a local secondary index you need to create a DynamoDB resource like this:
